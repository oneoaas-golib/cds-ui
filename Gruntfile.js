// Generated on 2016-02-22 using generator-ovh-stack 0.0.0
"use strict";
...
module.exports = function (grunt) {
    ...
    // Custom tasks
    grunt.loadTasks("./tasks");
    grunt.loadTasks("./tasks/translation/tasks");

    // Define the configuration for all the tasks
    grunt.initConfig({

        // Project settings
        mode: "development",    // used for constants
        ...
        json_merge: {
            component_translations: {
                files: {
                    "<%= yeoman.client %>/assets/translations/Messages_fr_FR.json": [
                        "<%= yeoman.client %>/**/Messages_fr_FR.json"
                    ],
                    "<%= yeoman.client %>/assets/translations/Messages_en_US.json": [
                        "<%= yeoman.client %>/**/Messages_en_US.json"
                    ]
                }
            }
        },
        ...
        watch: {
            ...
            i18n: {
                files: ["<%= yeoman.client %>/{app,components}/**/translations/*.xml"],
                tasks: ["ovhTranslation", "json_merge"]
            },
            livereload: {
                files: [
            ...
            less: {
                ...
                files: {
                    "<%= yeoman.client %>/app/app.less": [
                        ...
                        "!<%= yeoman.client %>/components/ovh-bootstrap-themes/**/*.less",
                        "!<%= yeoman.client %>/components/ovh-common-style/**/*.less"
                    ]
                }
            },
            ...
            css: {
                ...
                files: {
                    "<%= yeoman.client %>/index.html": [
                        ...
                        "!<%= yeoman.client %>/components/ovh-bootstrap-themes/**/*.css",
                        "!<%= yeoman.client %>/components/ovh-common-style/**/*.css"
                    ]
                }
            }
        },
        ...
        ngdocs: {
            options: {
                ...
                html5Mode: false,
                startPage: '/api',
                title: "CDSUi Documentation",
                titleLink: "/api",
                sourceLink: "https://github.com/ovh/cds-ui/browse/client/{{file}}#{{codeline}}"
            },
            api: {
                title: "Application",
    ...
    grunt.registerTask("serve", function (target) {
        ...
        grunt.config.set("cds.version", "devMode");
        if (target === "dist") {
    ...
    grunt.registerTask("test", function(target, option) {
        grunt.config.set("cds.version", "test-version");
    ...
    grunt.registerTask("build", function () {
        var version = grunt.option("cdsVersion");
        grunt.config.set("cds.version", version);
        grunt.config.set("mode", "production");
        grunt.task.run([
            "clean:dist",
            'ngdocs',
